...
const ModernProjects = () => {
  ...
  const ProjectImage = ({ project, onGalleryOpen, onInstagramOpen }) => {
      ...
      return (
        <div className="w-full space-y-8">
          ...
          <div className="relative w-full flex justify-center">
            <motion.div className="relative w-[280px]" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden border-[12px] border-gray-900 shadow-2xl bg-gray-900">
                ...
                {/* Screen content */}
                <motion.img src={project.mobileImage} alt="Mobile view" className="w-full object-contain rounded-xl" />
              </div>

              {/* Floating action buttons - more visible with labels */}
              <motion.div
              ...
              >
                {project.github && (
                  <motion.a
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-l-full bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg"
                ...
                {project.live && (
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-l-full bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg"
                    whileHover={{ scale: 1.05, x: -5 }}
                    whileTap={{ scale: 0.95 }}
                  >
                ...
                {project.galleryImages && (
                  <motion.button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-l-full bg-gradient-to-r from-pink-600 to-red-600 text-white shadow-lg"
                    whileHover={{ scale: 1.05, x: -5 }}
                    whileTap={{ scale: 0.95 }}
                  >
                ...
                {project.instagramPost && (
                  <motion.button
                    onClick={() => onInstagramOpen(project.instagramPost)}
                    className="flex items-center gap-2 px-3 py-2 rounded-l-full bg-gradient-to-r from-orange-500 to-pink-500 text-white shadow-lg"
                    whileHover={{ scale: 1.05, x: -5 }}
                    whileTap={{ scale: 0.95 }}
                  >
    ...
    // Desktop view with always visible action buttons
    return (
      <motion.div className="w-full lg:w-3/5 relative" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
        <RainBackground />
        <div className="relative overflow-hidden rounded-2xl group">
          ...
          {/* Semi-transparent overlay that's always visible but more prominent on hover */}
          <motion.div
            className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-70 group-hover:opacity-90 transition-all duration-300
            ...
            <div className="flex gap-4">
              {project.github && (
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/40 transition-all shadow-lg"
  ...
  return (
    <div
      className={`py-24 ${themeConfig[theme].primary} transition-colors duration-500 min-h-screen relative overflow-hidden`}
    >
          ...
          {currentProjects.map((project, index) => (
            ...
            >
              ...
              >
                ...
                <ProjectImage project={project} onGalleryOpen={openGallery} onInstagramOpen={openInstagramPost} />
                ...
                >
                  ...
                  >
                    ...
                    <p className={`${themeConfig[theme].text} opacity-90 relative z-10`}>{project.description}</p>
                  </motion.div>
          ...
          <div className="flex justify-center items-center mt-16 space-x-4">
            <motion.button
              ...
              className={`p-3 rounded-full transition-all duration-300 ${
                currentPage === 1 ? "opacity-30 cursor-not-allowed" : "hover:bg-blue-500/10 active:scale-95"
              }`}
            ...
            <motion.button
              ...
              className={`p-3 rounded-full transition-all duration-300 ${
                currentPage === totalPages ? "opacity-30 cursor-not-allowed" : "hover:bg-blue-500/10 active:scale-95"
              }`}
